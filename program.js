...
function checksyn() {
	if (document.getElementById("synonyms").value == loa[index] || 
	    document.getElementById("synonyms").value == loa1[index] && document.getElementById("synonyms").value !== "" ||
	    document.getElementById("synonyms").value == loa2[index] && document.getElementById("synonyms").value !== "") {
